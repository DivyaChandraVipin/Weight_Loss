...
public class Squats extends AppCompatActivity {
    ImageView squatFitness;
    AnimationDrawable frameAnimation;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.squat_fitness);
        squatFitness=(ImageView)findViewById(R.id.imgSquat);
        ...
        squatFitness.setBackgroundResource(R.drawable.squat);
        TextView tx = (TextView)findViewById(R.id.txtViewSquats);
        Typeface custom_font = Typeface.createFromAsset(getAssets(),"DroidSerif-Italic.ttf");

        tx.setTypeface(custom_font);
        // Typecasting the Animation Drawable
        frameAnimation = (AnimationDrawable) squatFitness.getBackground();
    }
    @Override

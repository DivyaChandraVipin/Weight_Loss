...
public class Sweets extends AppCompatActivity {
    ...
    String[] food={"BrownSugar(100g)","Honey(100gms)","Sugar,granulated sugar,white sugar(100gms","Choclate(100gms)",
            "Choclate bar with biscuit","White choclate(100gms)",
            "Sweetened dried cocoa powder","Soft nougat(100gms)","Marzipan(100gms)","Cake with cream and apple(100gms)",
            "Choclate cake(100gms)","Cream filled cake(100gms)","Fruit cake(100gms)"};
    int[] calorie={390,302,399,476,501,547,391,533,503,297,443,370,393};

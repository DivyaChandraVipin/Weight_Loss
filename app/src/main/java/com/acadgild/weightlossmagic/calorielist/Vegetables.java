...
public class Vegetables extends AppCompatActivity {
    ...
    String[] food={"Mushrooms canned in water(100gms)","Fresh mushroom(100gms)",
            "Spanish niscalo(100gms)","Beetroot(100gm)","Carrot(100gm)","Potato(100gm)",
            "Radish(100gm)","Tapioca(100gm)","Turnip(100gm","Carrot canned in water(100gm)"};
    int[] calorie={21,33,23,46,39,73,17,345,31,26};
